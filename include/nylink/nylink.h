...
typedef enum Nylink_Reloc_Type {
    ...
    NYLINK_RELOC_AARCH64_CALL26,
    NYLINK_RELOC_AARCH64_JUMP26,
    NYLINK_RELOC_AARCH64_ADR_PREL_PG_HI21,
    NYLINK_RELOC_AARCH64_ADD_ABS_LO12_NC,
    NYLINK_RELOC_AARCH64_LDST64_ABS_LO12_NC,
    NYLINK_RELOC_AARCH64_LDST32_ABS_LO12_NC,
    NYLINK_RELOC_AARCH64_ABS64,
} Nylink_Reloc_Type;
